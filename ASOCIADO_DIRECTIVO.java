...
public class ASOCIADO_DIRECTIVO extends ASOCIADOS {
    ...
    public ASOCIADO_DIRECTIVO(int num_socio, String nombre, int telefono, LocalDate fecha_ingreso, String cargo,
            LocalDate fecha_TomaPosesion, ASOCIADO_DIRECTIVO[] arreglo_AD, int contador_Asociados_Directivos) {
